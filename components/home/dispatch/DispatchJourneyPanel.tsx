...
export function DispatchJourneyPanel() {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="absolute -right-8 bottom-5 h-20 w-20 rounded-full bg-dispatch-mint/70 blur-2xl"
        data-editorial-panel-orbit
      />
      ...
      <div className="relative overflow-hidden  bg-dispatch-canvas/96">
        <div className="flex h-10 items-center justify-between border-b border-dispatch-ink/10 px-3.5 sm:px-5">
          <div className="flex items-center gap-2">
            <span className="grid h-5 w-5 place-items-center rounded-md bg-dispatch-ink text-[8px] font-bold text-dispatch-canvas">
              A
            </span>
          ...
          <div className="flex items-center gap-2 text-[8px] font-semibold text-dispatch-ink/82">
            <span className="hidden sm:inline">STAGE: APPLYING · UPDATED 2M AGO</span>
            <span className="h-1.5 w-1.5 rounded-full bg-dispatch-success" />
            <span className="grid h-5 w-5 place-items-center rounded-full bg-dispatch-ink text-[7px] text-dispatch-canvas">
              AM
            </span>
          </div>
        </div>
          ...
          >
            <div className="grid h-full grid-cols-[3.25rem_1fr] sm:grid-cols-[4.25rem_1fr]">
              <aside className="flex flex-col items-center gap-4 border-r border-dispatch-ink/8 py-5 text-dispatch-ink/30">
                <span className="grid h-7 w-7 place-items-center rounded-lg bg-dispatch-ink text-dispatch-canvas">
              ...
              <div className="p-4 sm:p-5">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <span className="rounded-full bg-dispatch-mint px-2.5 py-1 text-[8px] font-bold text-dispatch-ink">
                    3 things left
                  </span>
                </div>
                ...
                <div className="mt-4 grid gap-2 sm:grid-cols-[1.25fr_.75fr]">
                  <div className="rounded-xl border border-dispatch-ink/9 bg-white p-3">
                    ...
                    <span className="mt-3 inline-flex rounded-full bg-dispatch-ink px-2.5 py-1 text-[8px] font-semibold text-dispatch-canvas">
                      Due in 9 days
                    </span>
                  </div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div
                        className="flex items-center gap-2 rounded-xl bg-dispatch-sage/65 px-2.5 py-2"
                        key={university}
                      >
            ...
            <div className="grid h-full grid-cols-[3.25rem_1fr] sm:grid-cols-[4.25rem_1fr]">
              ...
              <div className="p-4 sm:p-5">
                ...
                <div className="mt-4 grid gap-2 sm:grid-cols-[.8fr_1.2fr]">
                  <div className="grid place-items-center rounded-xl bg-dispatch-ink p-3 text-center text-dispatch-canvas">
                    ...
                    <p className="mt-2 text-[8px] font-semibold text-dispatch-canvas/82">
                      PARTNERS
                    </p>
                  </div>
                  <div className="space-y-2">
          ...
          >
            <div className="grid h-full grid-cols-[3.25rem_1fr] sm:grid-cols-[4.25rem_1fr]">
              ...
              <div className="p-4 sm:p-5">
                ...
                <div className="relative mt-4 overflow-hidden rounded-xl bg-dispatch-sage/75 p-3">
                  <div
                    aria-hidden="true"
                    className="editorial-mini-map absolute inset-0 opacity-45"
                  />
                  <div className="relative grid gap-2 sm:grid-cols-3">
                    {[
                      ...
                      return (
                        <div
                          className="rounded-xl bg-dispatch-canvas/92 p-3"
                          key={String(day)}
                        >
