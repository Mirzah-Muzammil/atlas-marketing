...
export function Footer() {
  return (
    <footer
      className="relative overflow-hidden border-t border-zinc-900 bg-transparent pb-0 pt-20 text-zinc-400"
      data-atlas-site-footer
    >
      ...
      <div className="pointer-events-none -mb-39 -mt-10 flex w-full select-none justify-center">
        <Image
          ...
          height={747}
          src="/images/homepage/atlas-wordmark.png"
          width={2105}
        />
      </div>
    </footer>
