...
} from "@/components/homepage/ServiceArtwork";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 h-[58%] overflow-hidden border-t border-white/[.055] bg-black/[.08]">
        ...
        <ServiceArtwork index={index} visual={visual} />
...
export function ServiceCatalogSection() {
  ...
  return (
    <section
      className="relative isolate overflow-hidden bg-transparent py-16 text-white"
