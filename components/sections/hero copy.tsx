...
export default function HeroCopy({ primaryAction }: HeroProps = {}) {
  return (
    <section className="atlas-hero relative isolate h-[120svh] overflow-hidden bg-white text-[#171717]">
      ...
      <div className="atlas-hero__content relative z-10 mx-auto flex min-h-[100svh] w-full max-w-[1440px] items-center  px-5 pb-14 pt-28 sm:px-8 lg:px-12 xl:px-16">
        <div className="atlas-hero__message max-w-[46rem] top-0 -mt-20">
          <AnimatedTitle
