...
export default function CtaBanner() {
  return (
    <section className="min-w-7xl mt-60 mx-auto px-4 sm:px-6 lg:px-8 relative overflow-visible">
      <div
        className="bg-gradient-to-r from-[#FF5E1A] via-[#FF5E1A] to-[#FF904E] rounded-[32px] md:rounded-[40px] px-8 sm:px-12 md:px-16 py-8 flex flex-col md:flex-row items-center justify-between relative overflow-visible  shadow-lg"
        data-aos="fade-up"
      >
        ...
        <div className="relative md:absolute rounded-[32px] md:right-8 lg:right-0 w-full md:w-[350px] md:-bottom-1 lg:w-[420px] mt-8 md:mt-0 flex items-end justify-center z-20 overflow-visible">
          <Image
            ...
            width={1024}
            height={1536}
            className="object-contain rounded-[32px] h-max md:absolute md:bottom-0"
            priority
          />
        </div>
      </div>
