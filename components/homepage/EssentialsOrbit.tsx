...
const essentials = [
  { label: "University", image: "/images/homepage/product-planning.jpg" },
  { label: "Visa", image: "/images/homepage/visa.jpg" },
  { label: "Funding", image: "/images/homepage/loans.jpg" },
  { label: "Housing", image: "/images/homepage/housing.jpg" },
  { label: "Banking", image: "/images/homepage/banking.jpg" },
  { label: "Travel", image: "/images/homepage/atlas-departure.jpg" },
  { label: "Insurance", image: "/images/homepage/insurance.jpg" },
  { label: "Community", image: "/images/homepage/student-crowd.png" },
] as const;
...
export function EssentialsOrbit() {
  ...
  return (
    <section
      ...
      data-atlas-homepage-essentials
      id="essentials-orbit"
    >
