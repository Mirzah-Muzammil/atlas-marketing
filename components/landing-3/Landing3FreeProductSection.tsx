...
import styles from "./Landing3FreeProductSection.module.css";
...
export function Landing3FreeProductSection() {
  return (
    <section
      className="relative isolate overflow-hidden border-y border-white/[.07] bg-[#050506] px-5 py-24 text-white sm:px-8 sm:py-32"
      data-landing-3-free-product
      data-orange-origin="right"
      id="free-with-atlas"
    >
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 opacity-45 [background-image:linear-gradient(rgba(255,255,255,.026)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.026)_1px,transparent_1px)] [background-size:72px_72px] [mask-image:linear-gradient(to_bottom,transparent,black_18%,black_82%,transparent)]" />
