...
const journeyStages = [
  ...
  },
  {
    ...
    label: "Settle",
    image: "/images/homepage/journey-photos/home.jpg",
    imageName: "home",
    number: "03",
...
export function ServicesSection() {
  ...
  return (
    <section
      className="relative isolate bg-transparent text-white lg:min-h-[220svh]"
    ...
    >
      ...
      >
        ...
        <div className="relative mx-auto w-full max-w-[1240px]">
          ...
          <div className="relative mt-12 lg:mt-8" data-journey-rail>
            ...
            >
              ...
              <g aria-hidden="true" data-journey-flight ref={flightRef}>
                <g
                  className="atlas-homepage-journey-flight"
          ...
          <div
            className="atlas-homepage-journey-panel relative mt-10 border-y border-white/10 lg:mt-[124px]"
