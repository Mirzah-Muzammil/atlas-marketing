...
export function DashboardShowcase() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-transparent px-5 pb-16 pt-20 text-white sm:px-8 sm:pb-20" data-atlas-homepage-showcase id="platform" ref={sectionRef}>
      <div aria-hidden="true" className="pointer-events-none absolute inset-0"><div className="absolute inset-x-[12%] top-[28%] h-[62%] bg-[radial-gradient(ellipse_at_center,rgba(243,90,2,.105)_0%,rgba(55,25,10,.06)_38%,transparent_72%)] blur-2xl" /></div>
      <div className="relative mx-auto w-full max-w-[1400px]">
        <HomepageAnimatedTitle aria-label="From application to arrival. One Atlas, every next step." as="h2" className="mx-auto text-center text-[clamp(1.25rem,1.65vw,1.5rem)] font-medium leading-[1.25] tracking-[-.025em] text-white" data-showcase-heading><span className="block">From application to arrival.</span><span className="block text-white/48">One Atlas, every next step.</span></HomepageAnimatedTitle>
